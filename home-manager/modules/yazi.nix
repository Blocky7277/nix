    ...
    programs.yazi = {
        ...
        theme =  {
            manager = {
                ...
                marker_selected = { fg = "#f38ba8"; bg = "#f38ba8"; };
                ...
                count_selected = { fg = "#1e1e2e"; bg = "#f38ba8"; };
            ...
            mode = {
                normal_main = { fg = "#1e1e2e"; bg = "#f38ba8"; bold = true; };
                normal_alt = { fg = "#f38ba8"; bg = "#313244"; };
            ...
            spot = {
                border = { fg = "#f38ba8"; };
                title = { fg = "#f38ba8"; };
                tbl_cell = { fg = "#f38ba8"; reversed = true; };
                tbl_col = { bold = true; };
            };
